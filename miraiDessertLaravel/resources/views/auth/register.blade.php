...
<main class="main-content  mt-0">
  <section class="min-vh-75">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
      style="background-image: url({{asset('/assets/images/miraibg2.jpg')}}); background-position:top ;"">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Selamat Datang</h1>
            <p class="text-lead text-white">Silahkan registrasi diri Anda untuk menjadi Admin.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form action="/registeradmin" method="post" role="form text-left">
                @csrf
                <div class="mb-3">
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-success w-100 my-4 mb-2">Sign up</button>
                </div>
