...
Route::get('/',[OrderController::class, 'index'])->name('penjualanMirai')->middleware('auth');
// Route::get('/', function () {
...
Route::get('/akun',[AuthController::class, 'index'])->name('akun')->middleware('auth');
Route::get('/deleteAkun/{id}',[AuthController::class, 'deleteAkun'])->name('deleteAkun');
